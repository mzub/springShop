    ...
    public DefaultHandshakeHandler customHandShakeHandler() {
        return new DefaultHandshakeHandler() {
            ...
            protected Principal determineUser(ServerHttpRequest request, WebSocketHandler wsHandler, Map<String, Object> attributes) {
                ChatPrincipal chatPrincipal = new ChatPrincipal("user_" + userCounter.getAndIncrement());
                WebSocketConfig.logger.info("New chat user name is: " + chatPrincipal.getName());
